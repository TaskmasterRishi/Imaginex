    ...
    <Sheet open={true} onOpenChange={onClose}>
      <SheetContent className="max-w-full sm:max-w-xl w-full">
        <SheetHeader>
          ...
          <ScrollArea className="flex flex-col h-[110vh]">
            <div className="relative w-fit h-fit ">
              <Image
                ...
                className="w-full h-auto flex mb-3 rounded-lg"
              />
              <div className="flex gap-4 absolute bottom-4 right-4">
                <Button className="w-fit cursor-pointer" onClick={handelDownload}>
            ...
            <div className="flex flex-wrap gap-2">
              <Badge
                variant={"secondary"}
                className="border border-primary/50 rounded-lg px-4 py-2 text-xs"
              >
